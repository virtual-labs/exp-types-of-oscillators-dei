    ...
    _view._reset = function () {
      ...
      switch (_viewNumber) {
        ...
        case 0:
          ...
          _view.springBob.setAction("OnDrag", function (_data, _info) {
            x0 = x;
          }); // HtmlView Page setting action 'OnDrag' for element 'springBob'
...
function T06_SHO2_View_0(_topFrame) {
  ...
  _view._reset = function () {
    ...
    _view._addElement(EJSS_DRAWING2D.shape, "springBob", _view.drawingPanel) // EJsS HtmlView.HtmlView Page: declaration of element 'springBob'
      ...
      .setProperty("Enabled", true) // EJsS HtmlView.HtmlView Page: setting property 'Enabled' for element 'springBob'
      .setProperty("Sensitivity", 5) // EJsS HtmlView.HtmlView Page: setting property 'Sensitivity' for element 'springBob'
      ;
